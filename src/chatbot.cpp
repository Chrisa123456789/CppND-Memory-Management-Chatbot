...
ChatBot::ChatBot(const ChatBot &source) { //CG changed
...
ChatBot &ChatBot::operator=(const ChatBot &source){ //CG changed
...
ChatBot::ChatBot(ChatBot &&source) { //CG changed
...
ChatBot &ChatBot::operator=(ChatBot &&source) { //CG changed
